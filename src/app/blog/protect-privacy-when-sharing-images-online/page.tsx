    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="container mx-auto px-4 py-16 max-w-4xl">
        <nav className="text-sm text-gray-500 mb-8">
          ...
          {' > '}
          <span className="text-gray-900">Protect Privacy When Sharing Images</span>
        </nav>
        ...
        <header className="mb-12">
          ...
          <p className="text-xl text-gray-600">
            Learn essential strategies to prevent data leaks, identity theft, and
            privacy violations when sharing images online.
          </p>
        </header>

        <div className="prose prose-lg max-w-none">
          <h2 className="text-3xl font-bold mb-4">1. Blur Sensitive Information</h2>
          <p className="text-gray-700 mb-6">
            Before posting any image online, scan for personal data like addresses,
            license plates, credit card numbers, or sensitive documents visible in
            the background.
          </p>
          ...
          <h2 className="text-3xl font-bold mb-4">3. Use Privacy-First Tools</h2>
          <p className="text-gray-700 mb-6">
            Choose tools like BlurKit that process images in your browser without
            uploading to external servers. Your images never leave your device.
          </p>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg p-8 text-center mt-12">
            ...
            <p className="mb-6 text-blue-100">
              100% browser-based processing. Zero server uploads. Maximum privacy.
            </p>
            <Link href="/editor">
